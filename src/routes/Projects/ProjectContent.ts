export const textProjects = {
    pt: {
        ...
        projects: [
            ...
            {
                title: "Sovrano Web 🍽️",
                description: "Sovrano Web é o front-end do sistema de reservas online sofisticado. Ele oferece uma interface intuitiva e elegante para clientes de restaurantes de alto padrão, com um processo de reserva simples e eficiente.",
                link: "https://github.com/gabrieldiasmenezes/sovrano-web",
                image: "sovranoImg.jpg"
            },               
            {
                title: "FinNet 🚀",
            ...
            {
                title: "Money Control Web 💻",
                description: "O Money Control é uma plataforma completa para gestão financeira pessoal e empresarial. O Money Control Web funciona como o front-end do projeto, oferecendo uma interface moderna e intuitiva, construída com Next.js, shadcn/ui e Lucide, para proporcionar uma experiência de usuário incrível.",
                link: "https://github.com/gabrieldiasmenezes/money-control-web",
                image: "moneyControl.png"
            },
            {
                title: "Money Control API 💸",
                description: "O Money Control API é o back-end do projeto, fornecendo uma API RESTful segura e eficiente para gerenciamento financeiro. Ele suporta contas bancárias, transações, orçamentos e relatórios, garantindo controle total das finanças.",
                link: "https://github.com/gabrieldiasmenezes/money-control-api",
                image: "moneyControl.png"
            },
            {
                title: "Box-Pokemon",
    ...
    en: {
        ...
        projects: [
            ...
            {
                title: "Sovrano Web 🍽️",
                description: "Sovrano Web is the front-end of the sophisticated online reservation system. It provides an intuitive and elegant interface for high-end restaurant clients, ensuring a seamless and efficient reservation process.",
                link: "https://github.com/gabrieldiasmenezes/sovrano-web",
                image: "sovranoImg.jpg"
            },              
            {
            ...
            {
                title: "Money Control Web 💻",
                description: "Money Control is a complete financial management platform for personal and business use. Money Control Web serves as the front-end of the project, offering a modern and intuitive interface built with Next.js, shadcn/ui, and Lucide to provide an amazing user experience.",
                link: "https://github.com/gabrieldiasmenezes/money-control-web",
                image: "moneyControl.png"
            },
            {
                title: "Money Control API 💸",
                description: "Money Control API is the back-end of the project, providing a secure and efficient RESTful API for financial management. It supports bank accounts, transactions, budgets, and reports, ensuring full financial control.",
                link: "https://github.com/gabrieldiasmenezes/money-control-api",
                image: "moneyControl.png"
            },                             
            {
